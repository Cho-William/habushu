            ...
            Files.walk(directory)
                    ...
                    .forEach(path -> {
                        try {
                            ...
                            throw new HabushuException(String.format("Could not delete file: %s", path), ioe);
                        }
                    });
        } catch (IOException ioe) {
            throw new HabushuException(String.format("Error walking the directory: %s", directory), ioe);
        }
    }
}